<?php
class M_cakeshop extends Model {
	...
	function cakeshop_get_period_selection() {
	...
	function cakeshop_select_matr($date_from) {
        $plant = $this->session->userdata['ADMIN']['plant'];
...
//echo $swbQuery;
//echo $swbQuery;
//$this->db2->query("Usp_Report_cakeshop '$plant','$date_from'");
//$this->db2->from('rpt_cakeshop');
//$this->db2->where('WhsCode',$plant);*/
//$result = $this->msdb->output('Usp_Report_cakeshop', array('Whs'=>$plant, 'Date'=>$date_from), 'EXECUTE');
//$SP = "EXEC Usp_Report_cakeshop ?,?";
