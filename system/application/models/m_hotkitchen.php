<?php
class M_hotkitchen extends Model {

	function M_hotkitchen() {
		parent::Model();
	...
	function hotkitchen_get_period_selection() {
	...
	function hotkitchen_select_matr($date_from) {
        $plant = $this->session->userdata['ADMIN']['plant'];
...
//echo $swbQuery;
//echo $swbQuery;
//$this->db2->query("Usp_Report_hotkitchen '$plant','$date_from'");
//$this->db2->from('rpt_hotkitchen');
//$this->db2->where('WhsCode',$plant);*/
//$result = $this->msdb->output('Usp_Report_hotkitchen', array('Whs'=>$plant, 'Date'=>$date_from), 'EXECUTE');
//$SP = "EXEC Usp_Report_hotkitchen ?,?";
