...
class M_pastry extends Model {
	...
	function pastry_get_period_selection() {
	...
	function pastry_select_matr($date_from) {
        $plant = $this->session->userdata['ADMIN']['plant'];
...
//AND B.U_pastry = 1
//$this->db2->query("Usp_Report_Pastry '$plant','$date_from'");
//$this->db2->from('rpt_pastry');
//$this->db2->where('WhsCode',$plant);*/
//$result = $this->msdb->output('Usp_Report_Pastry', array('Whs'=>$plant, 'Date'=>$date_from), 'EXECUTE');
//$SP = "EXEC Usp_Report_Pastry ?,?";
