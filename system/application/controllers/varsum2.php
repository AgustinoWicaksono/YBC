<?php
class varsum2 extends Controller {
...
//			$this->l_auth->save_referer_and_login();
	...
	function browse() {
	  ...
	  /*   foreach($this->m_bar->bar_get_period_selection() as $data) {
		...
		$this->template->write_view('content', 'varsum2/varsum2_browse', $object);
	...
	function browse_search() {
		...
		redirect('varsum2/browse_result/'.$date_from.'/'.$group);
	...
	function browse_result($date_from = '', $group = '')	{
		...
		$this->l_page->save_page('varsum2_browse_result');
	/*	if($date_from !== '0') {
...
//			$object['data']['date_from'] = '';
	...
	//	$object['data'] = $data;
		...
		$this->load->view('varsum2/varsum2_browse_result', $object);
