<?php
class Delstockopname extends Controller {

	function Delstockopname() {
		parent::Controller();
...
//			$this->l_auth->save_referer_and_login();
		...
		if(!$this->l_auth->is_have_perm('delete_stockopname'))
			redirect('');
	...
	function browse() {
		...
		$object['page_title'] = 'Delete Stock Opname';
		$this->template->write_view('content', 'delstockopname/delstockopname_browse', $object);
	...
	function browse_search() {
		...
		redirect('delstockopname/browse_result/'.$input_month."/".$input_year);
	...
	function browse_result($input_month = '', $input_year = '')	{
		...
		$this->l_page->save_page('delstockopname_browse_result');
...
//			$object['data']['date_from'] = '';
		...
		$object['page_title'] = 'Delete Stock Opname';
		$this->template->write_view('content', 'delstockopname/delstockopname_browse_result', $object);
		$this->template->render();
	}
