            ...
            int i = 0;
             ...
             if (count != 0)
             {
                 do
                 {
                     ...
                     cmd.CommandText = "SELECT TGD.material_no, TGD.material_desc,TGD.gr_quantity, TGD.item, TGH.po_no,TGH.plant,TGD.uom FROM t_grpo_detail TGD JOIN t_grpo_header TGH ON TGD.id_grpo_header = TGH.id_grpo_header where TGD.id_grpo_header = '" + id + "'";
                     ds = new DataSet();
