    ...
    class inv_trf1
    {
        ...
        public DataSet getData()
        {
            ...
            try
            {
                    ...
                    perintah.CommandText = "SELECT b.address,b.post_code,b.city, a.created_date, a.plant, a.id_nonstdstock_header " +
                                           " FROM t_nonstdstock_header a JOIN m_outlet b ON a.plant = b.outlet where a.status = 2 and (a.pr_no ='' or a.pr_no is null) ";
