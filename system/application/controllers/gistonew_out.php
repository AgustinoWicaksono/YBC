...
*/
		...
		$object['field_name'] = array (
			'a'	=>	'Transfer Slip Number ',
			'b'	=>	'SR Number',
			'c'	=>	'Transfer Out To Outlet',
		);
...
/*
  ...
  */
	...
	function _input_add() {
		...
		$gistonew_out = $_POST;
		$id_gistonew_out_header = $this->m_gistonew_out->gistonew_out_details_select('id_gistonew_out_header');
		...
		if(isset($_POST['button']['save']) || isset($_POST['button']['approve'])) {
			...
			if(isset($_POST['button']['approve'])){
						$st1 = '2';
						$user = $gistonew_out_header['id_user_input'];
						}else{
						$st1 = '1';
						$user = 0;}
            ...
            $web_trans_id = $this->l_general->_get_web_trans_id($gistonew_out_header['plant'],$gistonew_out_header['posting_date'],
             ...
             if(isset($_POST['button']['approve'])) {
               $gistonew_out_to_approve = array (
				...
				$con = mysql_connect("localhost",$user_mysql,$pass_mysql);
				mysql_select_db($db_mysql, $con);
						mysql_query("INSERT INTO t_gistonew_out_header (id_user_input, plant, storage_location, posting_date, id_gistonew_out_plant, receiving_plant, receiving_plant_name, po_no, to_plant, gistonew_out_no, status, id_user_approved) VALUES
													('$gistonew_out_header[id_user_input]', '$gistonew_out_header[plant]', '$gistonew_out_header[storage_location]', '$gistonew_out_header[posting_date]', '$gistonew_out_header[id_gistonew_out_plant]', '$gistonew_out_header[receiving_plant]', '$gistonew_out_header[receiving_plant_name]', '$gistonew_out_header[po_no]', '$gistonew_out_header[to_plant]', '$gistonew_out_header[gistonew_out_no]', '$st1', '$user')", $con);
						//echo "INSERT INTO t_gistonew_out_header (plant, storage_location, posting_date, id_gistonew_out_plant, receiving_plant, receiving_plant_name, po_no, to_plant, gistonew_out_no) VALUES
													//('$gistonew_out_header[plant]', '$gistonew_out_header[storage_location]', '$gistonew_out_header[posting_date]', '$gistonew_out_header[id_gistonew_out_plant]', '$gistonew_out_header[receiving_plant]', '$gistonew_out_header[receiving_plant_name]', '$gistonew_out_header[po_no]', '$gistonew_out_header[to_plant]', '$gistonew_out_header[gistonew_out_no]')";
		...
		$last_id = mysql_insert_id();
			...
			if(isset($_POST['button']['save'])||($_POST['button']['approve'])) {
				
				
				//if($id_gistonew_out_header = $this->m_gistonew_out->gistonew_out_header_insert($gistonew_out_header['id_gistonew_out_header'])) {
				//echo '{'.$id_gistonew_out_header.'}';
				...
				for($i = 1; $i <= $count; $i++) {
					...
					if((!empty($gistonew_out['gistonew_out_detail']['gr_quantity'][$i]))&&(!empty($gistonew_out['gistonew_out_detail']['material_no'][$i]))) {
						...
						mysql_query("INSERT INTO t_gistonew_out_detail (gr_quantity, id_gistonew_out_h_detail, posnr, material_no, 
													num, outstanding_qty, material_desc, uom, uom_req, stock, id_gistonew_out_header) VALUES
													('$gistonew_out_detail[gr_quantity]', '$gistonew_out_detail[id_gistonew_out_h_detail]', '$gistonew_out_detail[posnr]', '$gistonew_out_detail[material_no]', 
													'$gistonew_out_detail[num]', '$gistonew_out_detail[outstanding_qty]', '$gistonew_out_detail[material_desc]', '$gistonew_out_detail[uom]', '$gistonew_out_detail[uom_req]' , '$gistonew_out_detail[stock]', '$last_id')", $con);
						/*echo "INSERT INTO t_gistonew_out_detail (gr_quantity, id_gistonew_out_h_detail, posnr, material_no, 
													num, outstanding_qty, material_desc, uom, uom_req, stock, id_gistonew_out_header) VALUES
													('$gistonew_out_detail[gr_quantity]', '$gistonew_out_detail[id_gistonew_out_h_detail]', '$gistonew_out_detail[posnr]', '$gistonew_out_detail[material_no]', 
													'$gistonew_out_detail[num]', '$gistonew_out_detail[outstanding_qty]', '$gistonew_out_detail[material_desc]', '$gistonew_out_detail[uom]', '$gistonew_out_detail[uom_req]' , '$gistonew_out_detail[stock]', '$last_id')";*/
...
//	 		  	$this->_edit_form(0, $data, $check);
	...
	function _edit_form($reset = 0, $data = NULL, $check = NULL) {
		...
		$id_gistonew_out_header = $data['gistonew_out_header']['id_gistonew_out_header'];
...
//exit;
	...
	function _edit_update() {
		...
		// check, at least one product gr_quantity entered
		$gr_quantity_exist = FALSE;
		//echo '-'.$gistonew_out['gistonew_out_detail']['gr_quantity'][$i].'-' ;
