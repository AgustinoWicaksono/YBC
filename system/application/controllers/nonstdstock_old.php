		...
		if(count($_POST) != 0) {
			...
			if(!isset($_POST['delete'])) {
				...
				for($i = 1; $i <= $count2; $i++) {
                    ...
                    if (!empty($_POST['nonstdstock_detail']['requirement_qty'][$i])&&($_POST['nonstdstock_detail']['requirement_qty'][$i]>0)&&!empty($_POST['nonstdstock_detail']['price'][$i])&&($_POST['nonstdstock_detail']['price'][$i]>0)) {
...
//			$nonstdstock_header['id_nonstdstock_header'] = '0001'.date("Ymd").sprintf("%04d", $running_number);
			...
			if($id_nonstdstock_header = $this->m_nonstdstock->nonstdstock_header_insert($nonstdstock_header)) {
				...
				for($i = 1; $i <= $count; $i++) {
					...
					if((!empty($nonstdstock['nonstdstock_detail']['requirement_qty'][$i]))&&(!empty($nonstdstock['nonstdstock_detail']['material_no'][$i]))&&($nonstdstock['nonstdstock_detail']['requirement_qty'][$i]>0)&&(!empty($nonstdstock['nonstdstock_detail']['price'][$i]))&&($nonstdstock['nonstdstock_detail']['price'][$i]>0) ) {
