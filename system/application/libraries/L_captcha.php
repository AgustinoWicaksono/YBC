...
class L_captcha
{
	...
	var $length = 6;
//	var $font = $this->obj->config->item('document_root').'system/fonts/arial.ttf';
	var $font = '/var/www/html/portal2.ybc.co.id/system/fonts/texb.ttf';
	var $size = 15;
	var $type = 'png';
	var $height = 40;
	var $width = 80;
...
// ------------------------------------------------------------------------
/* End of file L_captcha.php */
/* Location: ./system/application/libraries/L_captcha.php */