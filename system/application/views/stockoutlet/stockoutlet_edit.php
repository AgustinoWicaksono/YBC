...
?>
	...
	<tr>
    	...
    	<td class="column_input"><?=form_hidden('item_group[item_group_code]', $item_group['item_group_code']);?><?=$item_group['item_group_name'];?>
            ...
            <?php if(!empty($stockoutlet_header['item_group_code'])&&($function!=='edit')) : echo anchor('stockoutlet/input','<strong>Pilih ulang Material Group</strong>'); endif;?>        </td>
	</tr>
	<tr>
...
?>
		<td class="column_input">
            ...
            <?php else: ?><?=$posting_date;?><?=form_hidden("stockoutlet_header[posting_date]", $posting_date);?><?php endif;?>        </td>
	</tr>
	<tr>
	  <td colspan="2" align="right" class="table_field_1"><?=form_submit($this->config->item('button_save'), $this->lang->line('button_save'));?></td>
  </tr>
</table>
...
<table width="300" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
<?php if($data['stockoutlet_header']['status'] != '2') : ?>
		<td align="center"><a href="#" onclick="window.open('<?=base_url();?>help/Stock Opname.htm','popup','left=900 height=600,width=800,scrollbars=yes'); return(false);">
