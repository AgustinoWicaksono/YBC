...
<?php endif; ?>
	...
	<td class="" align="left" nowrap="nowrap"><?=anchor_image('tssck/edit/'.$tssck_header['id_tssck_header'].'/'.$tssck_header['receiving_plant'].'/'.$tssck_header['item_group_code'].'/1', 'Ubah dengan Item berdasarkan ID', 'edit.png', 'height="20" width="20"');?> <?=anchor_image('tssck/edit/'.$tssck_header['id_tssck_header'].'/'.$tssck_header['receiving_plant'].'/'.$tssck_header['item_group_code'].'/2', 'Ubah dengan Item berdasarkan Nama', 'view.png', 'height="20" width="20"');?> <?php if($tssck_header['status'] == 1) : ?><a href="#" onClick='confirm_tssck_delete("<?=site_url('tssck/delete/'.$tssck_header['id_tssck_header']);?>", "<?=$tssck_header['id_tssck_header'];?>")'><img src="<?=base_url().'images/'.$this->session->userdata('template').'/'.$this->session->userdata('lang_name').'/';?>delete.png" height="20" width="20" /></a><?php endif; ?></td>
	<td class="table_content_1" nowrap="nowrap"><?=$tssck_header['plant'];?><?=date("ymd", strtotime($tssck_header['posting_date']));?><?=sprintf("%06d", $tssck_header['id_tssck_plant']);?></td>
