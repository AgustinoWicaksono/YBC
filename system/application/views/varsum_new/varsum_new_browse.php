...
<?=form_open('varsum_new/browse_search', $form1);?>
  <tr>
    <td width="328" align="left"><strong>Dari Tanggal <span class="style2">(YYYY-MM-DD)</span>
    ...
    <td width="325" align="left"><strong>Sampai Tanggal <span class="style2">(YYYY-MM-DD)</span>
