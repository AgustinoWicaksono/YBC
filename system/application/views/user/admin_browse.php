...
<?=form_open('user/browse_search', $form1);?>
	<tr>
  ...
  <?=form_close();?>
	...
	<tr>
		<td colspan="3" class="space">[<?=anchor('user/input', $this->lang->line('admin_add'));?>]</td>
	</tr>
	<tr>
		<td>
...
<?php
				...
				echo anchor_image('user/profile_edit/'.$admin['admin_id'], $this->lang->line('admin_profile_edit'), 'edit.png', 'height="20" width="20"');

				echo " ";
				echo anchor_image('user/password_edit/'.$admin['admin_id'], $this->lang->line('admin_password_edit'), 'password.png', 'height="20" width="20"');
/*
...
?>
<a href="#" onClick='confirm_admin_delete("<?=site_url('user/delete/'.$admin['admin_id']);?>", "<?=$admin['admin_username'];?>")'><img src="<?=base_url();?>images/<?=$this->session->userdata('template');?>/<?=$this->session->userdata('lang_name');?>/delete.png" title="<?=$this->lang->line('delete');?>" height="20" width="20" /></a>
<?php
			}
?></td>
				</tr>
