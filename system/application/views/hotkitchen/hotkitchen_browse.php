...
<?=form_open('hotkitchen/browse_search', $form1);?>
  <tr>
    <td width="306" align="left"><strong>Dari Tanggal 
    ...
    <td width="330" align="left"><strong>Sampai Tanggal <span class="style2">(YYYY-MM-DD)</span>
...
while($r=mssql_fetch_array($gr))
    ...
    <td width="147"><?=form_submit($this->config->item('button_search'), 'Search');?></td>
  </tr>
</table>
