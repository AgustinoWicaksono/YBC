...
<?=form_hidden('id_status', $this->uri->segment(3));?>
	...
	<tr>
		<td>
			<table class="table-section">
				<tr>
					<td class="column_description">Employee Status</td>
					<td class="column_colon">:</td>
					<td class="column_input"><?=form_input('status', $data['status'], 'class="input_text"');?></td>
				</tr>
			</table>
		</td>
	</tr>
