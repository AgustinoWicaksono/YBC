...
?>
<?=form_open('produksi/file_import_execute', $form1);?>
...
if($produksi_headers !== FALSE) :
	$i = 1;
	foreach ($produksi_headers as $produksi_header) :
...
?>
	...
	<tr>
		...
		<td class="table_content_1"><?=$produksi_header['plant'];?></td>
        <td class="table_content_1"><?=$produksi_header['do_no'];?></td>
		<td class="table_content_1"><?=$produksi_header['storage_location'];?></td>
		<td class="table_content_1">Unapproved</td>
	</tr>
<?php
		$j = 1;
		foreach ($produksi_details[$i] as $produksi_detail[$i]) :
?>
	<tr>
		<td class="table_row_2"><?=$j;?></td>
		<td class="table_row_2"><?=$produksi_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$produksi_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$produksi_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$produksi_detail[$i]['uom'];?></td>
	</tr>
<?php
			$j++;
		endforeach;
