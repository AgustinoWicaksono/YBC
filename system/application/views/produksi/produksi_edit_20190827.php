...
//		a.material_no,a.material_desc,a.quantity,a.uom,'$kd_plant',$user FROM m_mpaket_detail a 
//		JOIN m_mpaket_header b  on a.id_mpaket_header=b.id_mpaket_header
//		where b.kode_paket='$kode_paket' and b.plant='WMSIASST'");
	...
	$tk="SELECT * FROM t_produksi_detail WHERE id_produksi_header='$id'";
		...
		{
		$tk="SELECT DISTINCT material_no, material_desc from m_mpaket_detail_temp WHERE whs='$kd_plant' AND user='$user'";
		//$tk="SELECT DISTINCT material_no, material_desc from m_mpaket_detail_tmp";
...
<?php
		...
		JOIN m_mpaket_header b  on a.id_mpaket_header=b.id_mpaket_header
		where b.kode_paket='$kode_paket' and b.plant='WMSIASST' AND a.material_no='$it'";
		//echo $tp;
