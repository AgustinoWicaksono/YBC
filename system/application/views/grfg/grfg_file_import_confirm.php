...
?>
<?=form_open('grfg/file_import_execute', $form1);?>
...
<table class="table-browse">
	...
	<tr>
		...
		<th class="table_header_1">Goods Receipt Qty.</th>
...
if($grfg_headers !== FALSE) :
	$i = 1;
	foreach ($grfg_headers as $grfg_header) :
?>
	<tr>
		<td class="table_content_1"><?=$grfg_header['grfg_no'];?></td>
	   	<td class="table_content_1"><?=$grfg_header['plant'];?></td>
		<td class="table_content_1"><?=$grfg_header['storage_location'];?></td>
		<td class="table_content_1">Unapproved</td>
	</tr>
<?php
		$j = 1;
		foreach ($grfg_details[$i] as $grfg_detail[$i]) :
?>
	<tr>
		<td class="table_row_2"><?=$j;?></td>
		<td class="table_row_2"><?=$grfg_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$grfg_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$grfg_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$grfg_detail[$i]['uom'];?></td>
