...
?>
<?=form_open('gisto/file_import_execute', $form1);?>
...
if($gisto_headers !== FALSE) :
	$i = 1;
	foreach ($gisto_headers as $gisto_header) :
...
?>
	...
	<tr>
		...
		<td class="table_content_1"><?=$gisto_header['plant'];?></td>
        <td class="table_content_1"><?=$gisto_header['do_no'];?></td>
		<td class="table_content_1"><?=$gisto_header['storage_location'];?></td>
		<td class="table_content_1">Unapproved</td>
	</tr>
<?php
		$j = 1;
		foreach ($gisto_details[$i] as $gisto_detail[$i]) :
?>
	<tr>
		<td class="table_row_2"><?=$j;?></td>
		<td class="table_row_2"><?=$gisto_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$gisto_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$gisto_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$gisto_detail[$i]['uom'];?></td>
	</tr>
<?php
			$j++;
		endforeach;
