...
<table width="1038" border="0" align="center">
  ...
  <tr>
    <td class="table_field_1"><strong>Transfer Out To Outlet</strong></td>
        ...
        <?php if(!empty($_POST)) : if(!empty($data['item_group_code'])) : echo anchor('gisto/input', '<strong>Pilih ulang Receiving Plant dan Material Group</strong>'); else : echo anchor('gisto/input', '<strong>Pilih Ulang Receiving Plant</strong>'); endif; endif;?>
        </td>
	</tr>
	<?php else : ?>
  <tr>
