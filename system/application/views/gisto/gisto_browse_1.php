...
<?php endif; ?>
	...
	<td class="table_content_1" nowrap="nowrap"><?=$gisto_header['plant'];?><?=date("ymd", strtotime($gisto_header['posting_date']));?><?=sprintf("%06d", $gisto_header['id_gisto_plant']);?></td>
    <td class =""><?=$gisto_header['gipo_no'];?></td>
