...
?>
<?=form_open('grsto/file_import_execute', $form1);?>
...
<table class="table-browse">
	<tr>
        <th class="table_header_1">Goods Receipt
Stock Transfer No</th>
		<th class="table_header_1"><strong>Store Room Request(SR)</strong> No.</th>
...
if($grsto_headers !== FALSE) :
	$i = 1;
	foreach ($grsto_headers as $grsto_header) :
?>
	<tr>
        <td class="table_content_1"><?=$grsto_header['grsto_no'];?></td>
		<td class="table_content_1"><?=$grsto_header['po_no'];?></td>
	  	<td class="table_content_1"><?=$grsto_header['plant'];?></td>
		<td class="table_content_1"><?=$grsto_header['storage_location'];?></td>
		<td class="table_content_1">Unapproved</td>
	</tr>
<?php
		$j = 1;
		foreach ($grsto_details[$i] as $grsto_detail[$i]) :
?>
	<tr>
		<td class="table_row_2"><?=$j;?></td>
		<td class="table_row_2"><?=$grsto_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$grsto_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$grsto_detail[$i]['outstanding_qty'];?></td>
		<td class="table_row_2"><?=$grsto_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$grsto_detail[$i]['uom'];?></td>
	</tr>
<?php
			$j++;
		endforeach;
