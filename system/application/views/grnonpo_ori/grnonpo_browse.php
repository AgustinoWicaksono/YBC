...
<?php endif; ?>
	...
	<td class="table_content_1" nowrap="nowrap"><?=$grnonpo_header['plant'].'07';?><?=date("ymd", strtotime($grnonpo_header['posting_date']));?><?=sprintf("%06d", $grnonpo_header['id_grnonpo_plant']);?></td>
