...
<table width="1200" border="0" align="center">
	<tr>
		<td width="272" class="table_field_1"><strong>Purchase Request (PR) </strong></td>
  ...
  <tr>
    <td class="table_field_1"><strong>Request Reason</strong></td>
        ...
        <?php if(!empty($_POST)) : if(!empty($data['item_group_code'])) : echo anchor('pr/input', '<strong>Pilih ulang Request Reason dan Material Group</strong>'); else : echo anchor('pr/input', '<strong>Pilih Ulang Request Reason</strong>'); endif; endif;?>
        </td>
	</tr>
	<?php else : ?>
  <tr>
...
while($r=sqlsrv_fetch_array($gr))
	...
	<tr>
		<td class="table_field_1"><strong>Material Group</strong></td>
		<td class="column_input"><?=form_dropdown('item_group_code', $group, $data['item_group_code'], ' data-placeholder="Pilih material group..." class="chosen-select input_text" style="width:250px;" onChange="document.form1.submit();"');?></td>
	<?php endif; ?>
	<?php if(!empty($data['request_reason']) && !empty($data['item_group_code'])) : ?>
	<tr>
