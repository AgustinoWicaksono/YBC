...
?>
<?=form_open('whole/file_import_execute', $form1);?>
...
if($whole_headers !== FALSE) :
	$i = 1;
	foreach ($whole_headers as $whole_header) :
...
?>
	...
	<tr>
		...
		<td class="table_content_1"><?=$whole_header['plant'];?></td>
        <td class="table_content_1"><?=$whole_header['do_no'];?></td>
		<td class="table_content_1"><?=$whole_header['storage_location'];?></td>
		<td class="table_content_1">Unapproved</td>
	</tr>
<?php
		$j = 1;
		foreach ($whole_details[$i] as $whole_detail[$i]) :
?>
	<tr>
		<td class="table_row_2"><?=$j;?></td>
		<td class="table_row_2"><?=$whole_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$whole_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$whole_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$whole_detail[$i]['uom'];?></td>
	</tr>
<?php
			$j++;
		endforeach;
