...
<table width="1038" border="0" align="center">
	...
	//$abc=$this->load->database('default', TRUE);
	//echo '['.$abc['default']['database'];;
	?>
...
while($r=sqlsrv_fetch_array($gr))
	...
	<?php endif; ?>
    <?php if(!empty($data['request_reason']) && !empty($data['item_group_code']) && !empty($data['item_choose']) ) : ?>
	<tr>
		<td class="table_field_1"><strong>SR To</strong></td>
		<td class="column_input"><?=form_dropdown('to', $to, $data['to'], 'class="input_text" onChange="document.form1.submit();"');?></td>
	</tr>
	<?php endif; ?>
</table>
<?=form_close();?>
