...
?>
  ...
  <tr>
    <td height="53"><!--img src='harvest1.png' width='221'-->      <h3 align="center"><strong>Bincard</strong></h3></td>
  </tr>
</table>
<a href="<?= site_url('bincard/browse_result_excel/'.$date_from.'/'.$group1.'/'.$group2.'/'.$group3.'/'.$date_to)?>">Cetak</a>
