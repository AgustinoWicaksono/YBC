...
<table width="1000"  align="center" class ="table_border_1">
  <tr bgcolor="#999999">
    ...
    <td width="160" class = "table_header_1" align="center"><strong>Goods Issue No<br /> <?=anchor_image($sort_link['by'],'A-Z', 'panahbawah.jpg');?><?=anchor_image($sort_link['bz'], 'Z-A','panahatas.jpg');?> </strong></td>
...
<?php endif; ?>
	...
	<td class="table_content_1" nowrap="nowrap"><?=$gitcc_header['plant'];?><?=date("ymd", strtotime($gitcc_header['posting_date']));?><?=sprintf("%06d", $gitcc_header['id_gitcc_plant']);?></td>
