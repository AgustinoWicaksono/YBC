...
<script language="javascript">
	function confirm_gistonew_dept_delete(url, id_gistonew_dept_header) {
		var m = confirm('Apakah Anda setuju untuk menghapus data Goods Issue Stock Transfer Antar Outlet  dengan ID "' + id_gistonew_dept_header + '" dan data item-item barang di dalamnya? Data yang sudah dihapus tidak bisa dimunculkan kembali.');
		if(m) {
			location.href=url;
		}
	}
