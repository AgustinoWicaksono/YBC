...
?>
<?=form_open('gistonew_out/file_import_execute', $form1);?>
...
if($gistonew_out_headers !== FALSE) :
	$i = 1;
	foreach ($gistonew_out_headers as $gistonew_out_header) :
...
?>
	...
	<tr>
		...
		<td class="table_content_1"><?=$gistonew_out_header['plant'];?></td>
        <td class="table_content_1"><?=$gistonew_out_header['do_no'];?></td>
		<td class="table_content_1"><?=$gistonew_out_header['storage_location'];?></td>
		<td class="table_content_1">Unapproved</td>
	</tr>
<?php
		$j = 1;
		foreach ($gistonew_out_details[$i] as $gistonew_out_detail[$i]) :
?>
	<tr>
		<td class="table_row_2"><?=$j;?></td>
		<td class="table_row_2"><?=$gistonew_out_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$gistonew_out_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$gistonew_out_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$gistonew_out_detail[$i]['uom'];?></td>
	</tr>
<?php
			$j++;
		endforeach;
