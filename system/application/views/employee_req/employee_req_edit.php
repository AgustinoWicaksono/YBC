...
<?=validation_errors('<tr><td colspan="2" class="error">','</td></tr>');?>
	...
	<tr>
		...
		<td class="column_input"><?=form_hidden('req[req_divisi]', $data['req']['req_divisi']);?><?=$divisi;?><?php echo anchor('employee_req/input', '<strong> Pilih ulang Divisi</strong>');?></td>
	</tr>
	<tr>
		<td width="272" class="table_field_1">Department</td>
		<td class="column_input"><?=form_hidden('req[req_dept]', $data['req']['req_dept']);?><?=$dept;?></td>
	</tr>
	<tr>
		<td width="272" class="table_field_1">Bagian</td>
		<td class="column_input"><?=form_hidden('req[req_bagian]', $data['req']['req_bagian']);?><?=$bagian;?></td>
	</tr>
	<tr>
		<td width="272" class="table_field_1">Jabatan</td>
		<td class="column_input"><?=form_hidden('req[req_jabatan]', $data['req']['req_jabatan']);?><?=$jabatan;?></td>
	</tr>
	<tr>
