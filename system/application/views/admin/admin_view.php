...
<?php endif; ?>
	...
	<tr>
		<td colspan="4" class="column_description_note"><?=form_submit($this->config->item('button_submit'), $this->lang->line($this->config->item('button_submit')));?> <?=form_reset('button[reset]', $this->lang->line('button_reset'));?> &nbsp;<?=form_button($this->config->item('button_cancel'), $this->lang->line('button_cancel'), "onclick=\"window.location='".site_url('admin/browse')."'\"");?></td>
	</tr>
</table>
<?=form_close();?>