...
<?=form_open('icecream/browse_search', $form1);?>
  <tr>
    <td width="249" align="left"><strong>Dari Tanggal <span class="style2">(YYYY-MM-DD)</span>
    ...
    <td width="268" align="left"><strong>Sampai Tanggal <span class="style2">(YYYY-MM-DD)</span>
...
while($r=mssql_fetch_array($gr))
    ...
    <td width="180"><?=form_submit($this->config->item('button_search'), 'Search');?></td>
  </tr>
</table>
