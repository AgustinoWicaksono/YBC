...
<table width="<?php echo $lebar; ?>" border="0" bordercolor="#000000" align="center">
  ...
  <tr>
    <?php if(($data['grpodlv_dept_header']['status'] == '2')&&($this->l_auth->is_have_perm('auth_cancel'))) { ?>
    <td colspan="8" style="padding:0px;text-align:left;margin:0px;" align="left"><?php } else { ?>
    </td>
    <td colspan="7" style="padding:0px;text-align:left;margin:0px;" align="left"><?php } ?>
...
//        }
		...
		{?>
          <td align="right"><?=number_format($outstanding_qty, 3, '.', ',');?>
