...
?>
	<tr>
		...
		<td class="table_row_2"><?=$grpodlv_detail[$i]['material_no'];?></td>
		<td class="table_row_2"><?=$grpodlv_detail[$i]['material_desc'];?></td>
		<td class="table_row_2"><?=$grpodlv_detail[$i]['outstanding_qty'];?></td>
		<td class="table_row_2"><?=$grpodlv_detail[$i]['gr_quantity'];?></td>
		<td class="table_row_2"><?=$grpodlv_detail[$i]['uom'];?></td>
	</tr>
<?php
			$j++;
		endforeach;
