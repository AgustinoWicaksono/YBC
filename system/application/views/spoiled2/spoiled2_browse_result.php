...
{
$grup_kode=$grup_item;
$swbQuery = "select a.docnum, a.DocDate,b.ItemCode, b.Dscription, str(b.Quantity) Quantity,b.WhsCode,b.unitMsr from OIGE a , IGE1 b, OITM c, OITB  d
where a.DocEntry= b.DocEntry
and b.ItemCode = c.ItemCode
and c.ItmsGrpCod =d.ItmsGrpCod
and b.U_Waste=1
and b.WhsCode='$plant'
...
?>
  ...
  <tr>
    <td height="53"><!--img src='harvest1.png' width='221'-->      <h3 align="center"><strong>Summary Spoiled</strong></h3></td>
  </tr>
</table>
    <table style="border-collapse:collapse;" width="780" border="1" align="center" class="table">
      
      <tr>
        <td width="27" height="24" align="center" bgcolor="#999999"><strong><span class="style12">No</span></strong></td>
        <td width="99" align="center" bgcolor="#999999"><span class="style12">Tanggal</span></td>
        <td width="59" align="center" bgcolor="#999999"><strong><span class="style12">CODE</span></strong></td>
        <td width="217" align="center" bgcolor="#999999"><strong><span class="style12">ITEM</span></strong></td>
        <td width="59" align="center" bgcolor="#999999"><strong><span class="style12">Quantity</span></strong></td>
        <td width="44" align="center" bgcolor="#999999"><strong><span class="style12">Uom</span></strong></td>
        <td width="144" align="center" bgcolor="#999999"><strong><span class="style12">Lokasi/Outlet</span></strong></td>
        <td width="79" align="center" bgcolor="#999999"><strong><span class="style12">No Spoiled</span></strong></td>
      </tr>
      <?php
  $no=1;
